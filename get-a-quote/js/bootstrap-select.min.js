    ...
    ! function(a) {
        ...
        k.VERSION = "1.12.3", k.DEFAULTS = {
            ...
            render: function(b) {
				...
				if (g.indexOf('Style') != -1) { 
					
					if (g.indexOf('Style 1') != -1) { 
						//g = g.replace('1', '<img src="https://beemloop.com/get-a-quote/img/style/style1.jpg" style="width: 15%;margin-left: 10px;">');
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style1.jpg" style="width: 15%;margin-left: 10px;">';
					}

					if (g.indexOf('Style 2') != -1) { 
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style2.jpg" style="width: 15%;margin-left: 10px;">';
					}					
				
					if (g.indexOf('Style 3') != -1) { 
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style3.jpg" style="width: 15%;margin-left: 10px;">';
					}

					if (g.indexOf('Style 4') != -1) { 
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style4.jpg" style="width: 15%;margin-left: 10px;">';
					}

					if (g.indexOf('Style 5') != -1) { 
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style5.jpg" style="width: 15%;margin-left: 10px;">';
					}

					if (g.indexOf('Style 6') != -1) { 
						g = g + '<img src="https://beemloop.com/get-a-quote/img/style/style6.jpg" style="width: 15%;margin-left: 10px;">';
					}					
					//alert(g);
					g = g.replace(/Style/g,'');
					//alert(g);
