...
(function () {
    let video = '<iframe class=\'embed-responsive-item\' src=\'https://www.youtube.com/embed/{%video%}?rel=0&amp;showinfo=0&autoplay=1\' frameborder=\'0\'  allow=\'autoplay\' allowfullscreen></iframe>';
    ...
    video_frame.on('click', function (e) {
		...
		$('.video__video[data-video="' + videoId + '"] .embed-responsive').html(video.replace('{%video%}', videoId));
        video_frame
