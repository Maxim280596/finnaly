...
/*
    ...
    $('.feat .owl-carousel').owlCarousel({
        ...
        autoplayTimeout:5000, //Время смены слайда
        autoplayHoverPause: true, //Остановка при ховере
        dragEndSpeed: 3000, //Время притягивания к краю
        responsive:{ //Адаптивность. Кол-во выводимых элементов при определенной ширине.
            0:{
                items:1,
                margin: 10
...
function initializeMap() {
    ...
    var myOdessa=new google.maps.LatLng(46.4813662, 30.7214623)
    ...
    var myLviv=new google.maps.LatLng(49.8435709, 24.0269542)
    ...
    var myKhmelnytskyi=new google.maps.LatLng(49.4227511, 26.9903895)
...
function moving (object, speed) {
    banner.on('mousemove', function(event) {
        ...
        var Y = Math.floor((event.pageY)/speed-9) + "px"; 
